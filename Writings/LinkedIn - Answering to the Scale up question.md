...
5. Product managers are shared resources, 50% for the company and 50% for the customers. You need to advocate for the users you are shipping your products to. It is one of the key characteristics that differentiate product managers from backlog managers. Whenever you are asked to build a feature or take on a task, ask yourself two questions: what does this do for the business, and what does it do for the customer? The amount of effort and money it needs to build a system robust enough to handle a million users will backfire if you are not thinking about the user experience around your product. Remember Skype? Skype was ready to handle three pandemics. Now, if you Google "Skype," you will see ads for Microsoft Teams, how ironic.
