...
5. Product managers are shared resources, split between the company and the customers. You must advocate for the users who will actually use your products, which is what differentiates true product managers from backlog managers. Whenever you are asked to build a feature or take on a task, ask yourself two questions: what does this do for the business and what does it do for the customer? The effort and cost required to build a system capable of handling a million users can backfire if you neglect the user experience. Take Skype, for example. It was technically ready to handle multiple global pandemics, but if you use it today, you will notice small issues, like faint laughter in the background, which show that robust infrastructure alone does not guarantee a great user experience.
